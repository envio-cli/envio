...
complete -c envio -n "__fish_seen_subcommand_from profile; and not __fish_seen_subcommand_from create; and not __fish_seen_subcommand_from delete; and not __fish_seen_subcommand_from list; and not __fish_seen_subcommand_from show" -l diagnostic -d 'Show diagnostic information for bug reports'
...
complete -c envio -n "__fish_seen_subcommand_from profile; and __fish_seen_subcommand_from create" -l diagnostic -d 'Show diagnostic information for bug reports'
complete -c envio -n "__fish_seen_subcommand_from profile; and __fish_seen_subcommand_from create" -s h -l help -d 'Print help'
complete -c envio -n "__fish_seen_subcommand_from profile; and __fish_seen_subcommand_from delete" -l diagnostic -d 'Show diagnostic information for bug reports'
...
complete -c envio -n "__fish_seen_subcommand_from profile; and __fish_seen_subcommand_from list" -l diagnostic -d 'Show diagnostic information for bug reports'
...
complete -c envio -n "__fish_seen_subcommand_from profile; and __fish_seen_subcommand_from show" -l diagnostic -d 'Show diagnostic information for bug reports'
